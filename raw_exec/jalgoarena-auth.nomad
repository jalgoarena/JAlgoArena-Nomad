job "jalgoarena-auth" {
  ...
  group "jalgoarena-auth" {
    ...
    task "jalgoarena-auth" {
      ...
      artifact {
        source  = "https://github.com/jalgoarena/JAlgoArena-Auth/releases/download/20180810101855-28e40ec/JAlgoArena-Auth-2.4.165.zip"
      }
      ...
      config {
        ...
        args = [
          "-Xmx400m", "-Xms50m",
          "-jar", "local/jalgoarena-auth-2.4.165.jar"
        ]
      }
